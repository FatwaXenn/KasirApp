...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 23, 2024 at 01:54 AM
...
(51, 'K.044', 'Coffee Boba Sundae', 18000, 65),
...
--
ALTER TABLE `penjualan`
  MODIFY `penjualan_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;
...
--
ALTER TABLE `tambah_stok`
  MODIFY `tambah_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
COMMIT;
